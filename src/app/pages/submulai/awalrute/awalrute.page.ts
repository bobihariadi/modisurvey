...
@Component({
  selector: 'app-awalrute',
  templateUrl: './awalrute.page.html',
  styleUrls: ['./awalrute.page.scss'],
})
export class AwalrutePage implements OnInit {
  dateBegin: any = '';
  startDate: any = '';
  jamAwal: string;
  arrDays: any[] = [
      ...
      buttons: [
        ...
        },
        {
          ...
          handler: async () => {
            ...
            timer(2000).subscribe(() => this.router.navigateByUrl('mulai'));
          },
        },
      ],
    });
